       ...
       <div class = "col-xs-12 col-md-12">
           <div class="row row-eq-height">
               ...
               <div class="col-xs-8 col-md-8 content-background">
                       <h2>Characters With Selected Homeland</h2>
                       ...
                       <table class ="table table-striped">
                           ...
                           <?php
                           if(!($stmt = $mysqli->prepare("SELECT characters.name FROM gameChars INNER JOIN characters ON characters.characterID = gameChars.cid WHERE gid=?"))){
                               echo "Prepare failed: "  . $stmt->errno . " " . $stmt->error;
                           }

                           if(!($stmt->bind_param("s",$_POST['gameTitle']))){
