		...
		<div class = "col-xs-12 col-md-12">
			<div class="row row-eq-height">
				...
				<div class="col-xs-8 col-md-8 content-background">
						<h2>Locations With Selected Environment</h2>
						...
						<table class ="table table-striped">
							...
							if(!($stmt = $mysqli->prepare("SELECT locationName FROM locations WHERE environment=?"))){
								echo "Prepare failed: "  . $stmt->errno . " " . $stmt->error;
							}
							
							if(!($stmt->bind_param("s",$_POST['environment']))){
