		...
		<div class = "col-xs-12 col-md-12">
			<div class="row row-eq-height">
				...
				<div class="col-xs-8 col-md-8 content-background">
						<h2>Games Featuring Selected Character</h2>
						...
						<table class ="table table-striped">
							...
							if(!($stmt = $mysqli->prepare("SELECT gameTitle, releaseYear FROM games INNER JOIN gameChars ON gameChars.gid = games.gameID INNER JOIN characters ON characters.characterID = gameChars.cid WHERE characters.name=? ORDER BY releaseYear, gameTitle"))){
								echo "Prepare failed: "  . $stmt->errno . " " . $stmt->error;
							}
							
							if(!($stmt->bind_param("s",$_POST['charName']))){
							...
							if(!$stmt->bind_result($gameTitle, $relYear)){
